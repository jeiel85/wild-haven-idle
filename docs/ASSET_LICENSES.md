...
|---|---|---|---|---|---|---|
| App icon source | `docs/assets/wild-haven-icon-source.png` | Self-generated geometric raster asset with local PIL script | Owned | Yes | Yes | Minimal sanctuary shield and leaf mark, no text, no external source image |
| App launcher icons | `app/src/main/res/mipmap-*/ic_launcher*.png` | Derived from `docs/assets/wild-haven-icon-source.png` | Owned | Yes | Yes | Density-specific Android launcher icons generated from the minimal source |
...
| Forest sanctuary header (habitat_forest_001) | `app/src/main/res/drawable-nodpi/wh_habitat_forest_001.png` | `docs/assets/source/wh_habitat_forest_001.png` (= bakeoff/habitat_forest_001/dalle3-1.png) | OpenAI ChatGPT Plus | DALL·E 3 / gpt-image-1 (2026-05-14) | `docs/assets/prompts/wh_habitat_forest_001.txt` (SHA-256 prefix `b4ed0cad51ec`) | None (가로 풀폭, 동물·사람·건물 일체 금지, 좌상단 비움/우상단 햇살 제약) | 2026-05-14 | 1672×941 → 960×540 LANCZOS 리사이즈, PIL 256-color quantize (395 KB) | Project-owned (OpenAI gpt-image-1) |
